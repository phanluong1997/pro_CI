...
<html lang="en">
	...
	<body>
		...
		<div class="page-wrapper">
			...
			<nav id="sidebar" class="sidebar-wrapper">
				...
				<div class="sidebar-brand">
					<a href="index.html" class="logo">
						<img src="img/logo.png" alt="SmartQ Admin Dashboard" />
					</a>
				</div>
				<!-- Sidebar brand end  -->
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="crm-dashboard.html" class="current-page">CRM Dashboard</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">CRM Dashboard</li>
					</ol>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="goal-card">
								<h6><i class="icon-user1"></i>Customers</h6>
								<h2>500</h2>
							</div>
						</div>
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="goal-card light">
								<h6><i class="icon-shopping-bag1"></i>Revenue</h6>
								<h2>900</h2>
							</div>
						</div>
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="goal-card">
								<h6><i class="icon-file-text"></i>Invoices</h6>
								<h2>250</h2>
							</div>
						</div>
					</div>
		...
		************* -->
		...
		<script src="vendor/apex/crm/compare-sales.js"></script>
		<script src="vendor/apex/crm/compare-sales1.js"></script>
