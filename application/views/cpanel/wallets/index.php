								...
								<?php foreach ($datas as $key => $val) { ?>
									<tr>
										...
										<td class="text-center">
											...
											<?php if($val['userID'] == 0){ ?>
												<a class="btn btn-info text-white" href="cpanel/wallets/addUserInWallet/<?php echo $val['id'];?>"><i class="icon-edit"></i></a>
											<?php } ?>
											<a class="btn btn-info text-white" href="cpanel/wallets/edit	/<?php echo $val['id'];?>"><i class="icon-edit"></i></a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
